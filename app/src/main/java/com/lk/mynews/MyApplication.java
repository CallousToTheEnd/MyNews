...
//                .discCacheFileCount(100) //缓存的文件数量
    ...
    private DisplayImageOptions getDefaultImageLoaderOptions() {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .showImageOnLoading(com.lk.mynews.R.mipmap.base_common_default_icon_small) // resource or drawable
                .showImageForEmptyUri(com.lk.mynews.R.mipmap.base_common_default_icon_small) // resource or drawable
                .showImageOnFail(com.lk.mynews.R.mipmap.base_common_default_icon_small) // resource or drawable
